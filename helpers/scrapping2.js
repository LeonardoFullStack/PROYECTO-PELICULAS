...
async function searchGoogle() {
  ...
  //todo await page.click(".sc-eDvSVe gYiBCk");

  //Acceder al buscador de amazon por su selector. ('Selector','Búsqueda').

  //todo await page.click(".searchbar-input sc-ion-searchbar-md");


  await page.type(".searchbar-input sc-ion-searchbar-md", "batman y robin");
